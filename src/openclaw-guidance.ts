...
const guidance = [
  ...
  "If your host forbids verification codes in chat, direct the owner to log in or register in the Embassys app for the same installation. Existing setups use Account > Set up this device. Follow the host's credential policy.",
