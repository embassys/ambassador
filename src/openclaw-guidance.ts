...
const guidance = [
  ...
  "If your host forbids verification codes in chat, direct the owner to Registration in the Embassys app for the same installation. Follow the host's credential policy.",
