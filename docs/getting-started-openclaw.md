...
When diagnosing the hosted development service, add `--verbose=true`. This prints request and response bodies to stderr. Tokens and verification codes are redacted, but emails and message content are visible. Do not redirect it to a file.
