# Implementation history through September 14, 2026

Historical record only. Some statements below describe limitations that were
subsequently resolved. Use [Current work](implementation-plan.md) and the dated
qualification records for current status.
